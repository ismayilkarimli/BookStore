...
public record AuthorDto(
        ...
        @Pattern(regexp = "^[A-Za-z-' ]*$", message = "author name can only include letters, dash, and apostrophe")
        String name,

        @JsonProperty("lastName")
        @NotBlank(message = "author last name cannot be blank")
        @Pattern(regexp = "^[A-Za-z-' ]*$", message = "author last name can only include letters, dash, and apostrophe")
        String lastName,
